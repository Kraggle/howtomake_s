...
function htm_s_on_install() {
	...
	if (function_exists('acf_add_local_field_group')) {
						...
						array(
							...
							'sub_fields' => array(
								...
								array(
									...
									'name' => 'sticky',
									'type' => 'true_false',
									'instructions' => 'Make this panel sticky? There can only be one sticky panel. The first found will be used.',
									'required' => 0,
									'conditional_logic' => 0,
									'wrapper' => array(
										'width' => '',
		...
		acf_add_local_field_group(array(
			'key' => 'group_6035006f0c621',
			'title' => 'Page Extras',
			'fields' => array(
				array(
					'key' => 'field_6036a2ccdf147',
					'label' => 'Description',
					'name' => 'description',
					'type' => 'wysiwyg',
					'instructions' => 'This, when populated, will show below the title and above the content.',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array(
						'width' => '',
				...
				array(
					'key' => 'field_6037faf6e2c12',
					'label' => 'Right Side Panels',
					'name' => 'right_sidebar',
					'type' => 'clone',
					'instructions' => '',
					'required' => 0,
		...
		acf_add_local_field_group(array(
			'key' => 'group_6037c592481ee',
			'title' => 'Snippet',
			'fields' => array(
				array(
					'key' => 'field_6037c73ad6bdc',
					'label' => 'Type',
					'name' => 'type',
					'type' => 'taxonomy',
					'instructions' => '',
				...
				array(
					'key' => 'field_6037c5bdbbd43',
					'label' => 'Content',
					'name' => 'content',
					'type' => 'wysiwyg',
					'instructions' => 'This section will only be used if you set the type to \'Content\'.',
					'required' => 0,
					'conditional_logic' => array(
						array(
							array(
								'field' => 'field_6037c73ad6bdc',
								'operator' => '>',
								'value' => '21156',
							),
							array(
				...
				array(
					'key' => 'field_6037cefda1d20',
					'label' => 'Side Bar',
					'name' => 'bar',
					'type' => 'clone',
					'instructions' => 'These are displayed, if there are any, on the right-hand side of the page.',
					'required' => 0,
					'conditional_logic' => array(
						array(
							array(
