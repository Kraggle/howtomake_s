...
K.loadStylesWithCondition = (ifTrue, stylesheets) => ifTrue && K.loadStyles(stylesheets);
...
K.Evented = K.Class.extend({
	...
	fire(type, data, propagate) {
		...
		const event = K.Util.extend({}, data, { type, target: this });
